...
import Icon from '../../public/icons/anticipate.svg'
  ...
  return (
    <div className="relative flex flex-col md:flex-col lg:flex-row xl:flex-row justify-center gap-[20px] w-full h-full">
      <div className="lg:sticky lg:top-0 flex flex-col justify-center items-center lg:w-1/3 md:w-full xl:w-1/3 h-full p-6">
        ...
        >
          <div className="h-[26px] w-[29px] flex items-center justify-center gap-3 absolute top-[220px] left-[14.8px] bg-transparent" style={{ backgroundImage: `url(${small_diamond})`, backgroundRepeat: 'no-repeat' }}>
